...
namespace MongoRepos
{
    ...
    {
        /// <summary>
        /// The default key NoSqlRepository will look for in the App.config or Web.config file.
        /// </summary>
        private const string DefaultConnectionstringName = "MongoServerDefaultConnection";
        private const string connString = "mongodb://localhost/CalendarDb";
        private const string db = "CalendarDb";
        ...
        {
            return connString;
            //eturn ConfigurationManager.ConnectionStrings[DefaultConnectionstringName].ConnectionString;
        }
        ...
        private static IMongoDatabase GetDatabaseFromUrl(MongoUrl url)
        {
            ...
            return client.GetDatabase(db);// url.DatabaseName); // WriteConcern defaulted to Acknowledged
        }
